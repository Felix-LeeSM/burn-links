...
- Require a `## Flick Subagent Review` PR comment created after the latest
  commit and carrying the exact PR head SHA.
- Publish the required `Review gate` commit status against the PR head SHA.
